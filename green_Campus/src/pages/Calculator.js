...
const Calculator = () => {
  ...
  const calculateFootprint = async (
    ...
    try {
      await addTravel({
        variables: { fourVheelersEmissions, publicTransitEmissions,  twoVheelersEmissions,collegeBusEmissions },
      });
      await addHome({
        variables: { waterEmissions, electricityEmissions, naturalGasEmissions,fuelOilEmissions },
      });
      
      await addWaste({
        variables: { plasticWasteEmissions, metalWasteEmissions, paperWasteEmissions,messFoodEmissions },
      });
              ...
              <div className="calculator">
                <div className="grid">
                  ...
                  <div>
                    ...
                    <Box sx={{ m: 1, width: 300 }}>
                      <label className="slider">
                        Post consumer waste(paper,Magzines)
                      </label>
                      <Slider
                        sx={{
                          color: "green",
